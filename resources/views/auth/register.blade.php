...
<head>
    ...
    {{-- Tailwind via Vite (si está activo) --}}
...
<div class="min-h-screen flex flex-col justify-center items-center">
    ...
    <div class="w-full max-w-md bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        @if ($errors->any())
            <div class="mb-4">
                <div class="font-medium text-red-600">
                    Ups, ocurrió un problema con tus datos.
                </div>
        ...
        {{-- Botón Volver con tu lógica actual --}}
        @php
            $previous    = url()->previous();
            $loginUrl    = route('login');
            $registerUrl = route('register');
            $fallback    = route('public.rides.index');

            $backUrl = in_array($previous, [$loginUrl, $registerUrl])
                ? $fallback
                : $previous;
        @endphp
