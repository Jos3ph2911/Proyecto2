...
<head>
    <meta charset="UTF-8">
    <title>Nuevo vehículo - Aventones</title>
    <style>
...
<div class="container">
    ...
    <form method="POST" action="{{ route('vehicles.store') }}" enctype="multipart/form-data">
        ...
        <input id="placa" name="placa" type="text" value="{{ old('placa') }}" required>
        ...
        <input id="anio" name="anio" type="number" value="{{ old('anio') }}">

        <label for="capacidad">Capacidad (asientos)</label>
        <input id="capacidad" name="capacidad" type="number" min="1" value="{{ old('capacidad') }}" required>
